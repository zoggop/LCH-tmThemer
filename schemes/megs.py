...
palettes = {
	'grayscale' : {
		'palette' : {'chroma':0, 'hue':0, 'xMin':0.25, 'xMax':0.70},
		'groups' : [
	...
	'background' : {
		'palette' : {'lightness':0.35, 'chroma':0.1, 'lightnessWidth':0},
		'groups' : [
	...
	'foreground' : {
		'palette' : {'lightness':0.70, 'chroma':0.14, 'lightnessWidth':0},
		'groups' : [
	...
	'comment' : {
		'palette' : {'lightness':0.60, 'chroma':0.05, 'lightnessWidth':0},
		'groups' : [
			[],
			{'comment':'foreground', 'punctuation.definition.comment':'foreground', 'findHighlight':''},
			[],
			[],
			[],
			[],
