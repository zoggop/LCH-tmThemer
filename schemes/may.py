...
palettes = {
	'grayscale' : {
		'palette' : {'chroma':0.4, 'hue':80, 'xMin':0.15, 'xMax':0.75},
		'groups' : [
	...
	'background' : {
		'palette' : {'lightness':0.15, 'chroma':0.05, 'lightnessWidth':0},
		'groups' : [
	...
	'foreground' : {
		'palette' : {'lightness':0.75, 'chroma':0.155, 'lightnessWidth':0},
		'groups' : [
	...
	'comment' : {
		'palette' : {'lightness':0.50, 'chroma':0.06, 'lightnessWidth':0},
		'groups' : [
			[],
